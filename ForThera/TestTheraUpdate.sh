...
sudo wget https://github.com/christianhaitian/rk2020/rgb10/master/ForThera/BootFileUpdates.tar.gz -a "$LOG_FILE"
sudo wget https://github.com/christianhaitian/rk2020/rgb10/master/ForThera/KernelUpdate.tar.gz -a "$LOG_FILE"
